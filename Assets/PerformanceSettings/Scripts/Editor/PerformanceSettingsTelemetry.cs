...
namespace Meta.PerformanceSettings
{
    ...
    /// </summary>
    [InitializeOnLoad]
    public static class PerformanceSettingsTelemetry
    {
        // This is the name of this showcase
        private const string PROJECT_NAME = "Unity-PerformanceSettings";
        ...
        static PerformanceSettingsTelemetry() => Collect();
